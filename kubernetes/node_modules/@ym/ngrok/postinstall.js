/*
- downloads archived binary from ym ngrok cdn (if not found in local cache)
...
function getCdnUrl() {
  ...
  const cdn = process.env.NGROK_CDN_URL || "https://cdn.yellowmessenger.com";
  const cdnPath = process.env.NGROK_CDN_PATH || "/ngrok/";
  const cdnFiles = {
